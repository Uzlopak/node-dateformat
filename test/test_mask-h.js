...
describe("Mask: 'h'", function () {
  it("should format '2020-10-22T22:10:59.736' as '10'", () => {
    var date = new Date("2020-10-22T22:10:59.736");
    var d = dateFormat(date, "h");
    strictEqual(d, "10");
  });

  it("should format '2020-10-13T13:30:41.278' as '1'", () => {
    var date = new Date("2020-10-13T13:30:41.278");
    var d = dateFormat(date, "h");
    strictEqual(d, "1");
  });

  it("should format '1993-02-19T03:18:18.711' as '3'", () => {
    var d = dateFormat("1993-02-19T03:18:18.711", "h");
    strictEqual(d, "3");
  });

  it("should format '2134-01-25T02:20:42.816' as '2'", () => {
