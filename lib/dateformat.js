 ...
 * @param  {number} options.y - Year
 * @param  {number} options.m - Month (0-11)
 * @param  {number} options.d - Day of the month (1-31)
 * @param  {Object} options._ - Date functions (getDate, getMonth, getFullYear)
 ...
 * @return {String}
 */
const getDayName = ({ y, m, d, _, D, short}) => {
